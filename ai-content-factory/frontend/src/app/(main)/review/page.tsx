...
const MOMENT_BADGE: Record<MomentType, { emoji: string; label: string; color: string }> = {
...
function MomentBadge({ type, small }: { type?: string; small?: boolean }) {
  if (!type) return null;
  const cfg = MOMENT_BADGE[type as MomentType];
  if (!cfg) return null;
  return (
    <span style={{
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 5, marginTop: 3, flexWrap: "wrap" }}>
                      ...
                      <MomentBadge type={clip.moment_type} small />
                    </div>
                  </div>
                </div>
              ))}
            ...
            <div className="review-main">
              ...
              <div className="review-meta-panel">
                ...
                <div className="review-meta-row">
                  ...
                  <MomentBadge type={activeClip.moment_type} />
                </div>
                ...
                {activeClip.ai_provider_used && (
                  <div style={{
                    ...
                    <span style={{ opacity: 0.6 }}>🤖 Generated by:</span>
                    <span style={{
